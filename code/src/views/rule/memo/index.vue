  ...
  <div class="app-container">
      ...
      <div>
          <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
            <el-form-item label="名称：">
              <el-input style="width: 160px" v-model="listQuery.name" placeholder="公司名称"></el-input>
            </el-form-item>
            <el-form-item label="奖惩对象：">
              <el-input style="width: 160px" v-model="listQuery.field" placeholder="奖惩对象"></el-input>
            </el-form-item>
            <el-form-item label="启用状态：">
            <el-select style="width: 140px" v-model="listQuery.verifyStatus" class="input-width" placeholder="全部" clearable>
    ...
    <div class="table-container">
      <el-table ref="productTable"
        ...
        <el-table-column label="奖惩对象" align="center"  >
          <template slot-scope="scope">{{scope.row.field}}</template>
        </el-table-column>
        <el-table-column label="发文单位" width="110" align="center">
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        fetchMemoList(this.listQuery).then(response => {
          // this.$message({
          //     message: '查询成功',
          //     type: 'success',
          //     duration: 1000
