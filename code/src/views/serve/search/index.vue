  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productTable"
        ...
        <el-table-column label="惩戒声明" align="center">
          <template slot-scope="scope">{{scope.row.reson}}</template>
        </el-table-column>
         <el-table-column label="名单状态" width="90" align="center">
          <template slot-scope="scope"  >
    ...
    <el-dialog
      ...
      <el-form label-width="150px">
        ...
        <el-form-item label="奖惩对象领域">
          <el-input v-model="editInfo.reson"></el-input>
        </el-form-item>
