    ...
    <el-card class="filter-container con-mar20" shadow="never" >
      <div>
          <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
            ...
            <el-form-item>
              <el-button type="primary" @click="handleSearchList()">核查</el-button>
    ...
    <div class="table-container">
      <el-table ref="productTable"
        ...
        <el-table-column label="用途" align="center">
          <template slot-scope="scope">{{scope.row.use}}</template>
        </el-table-column>
   
        <el-table-column label="结果" width="90" align="center">
          <template slot-scope="scope">{{scope.row.ressult}}</template>
        </el-table-column>
        <el-table-column label="统计" width="90" align="center">
        ...
        <el-table-column label="操作" width="120"  align="center">
          <template slot-scope="scope">
            <p>
              <el-button
                size="mini"
                @click="handleShowProduct(scope.$index, scope.row)">查看结果
              </el-button>
            </p>
          </template>
        </el-table-column>
    ...
    <el-dialog
      ...
      <el-form label-width="150px">
        ...
        <el-form-item label="用途">
          <el-input v-model="examList.use"></el-input>
        </el-form-item>
        <el-form-item label="结果">
          <el-input v-model="examList.ressult"></el-input>
        </el-form-item>
        <el-form-item label="统计">
          <el-input v-model="examList.record"></el-input>
        </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        fetchApiList(this.listQuery).then(response => {
          // this.$message({
          //     message: '查询成功',
          //     type: 'success',
          //     duration: 1000
